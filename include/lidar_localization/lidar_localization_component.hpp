...
public:
    ...
    void ekfPoseReceived(const geometry_msgs::msg::PoseWithCovarianceStamped::SharedPtr msg);
    // void gnssReceived();
    ...
    geometry_msgs::msg::PoseWithCovarianceStamped::SharedPtr ekf_pose_with_cov_stamped_ptr_;
